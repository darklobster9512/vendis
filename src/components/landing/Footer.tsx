  ...
  <footer className="bg-ink text-ink-foreground">
    <div className="max-w-7xl mx-auto px-5 sm:px-8 pt-20 pb-10 sm:pt-28">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 py-14">
        <div>
          <Link to="/" className="inline-flex items-center" aria-label="Vendis Development Services — Startseite">
            <img
              src={vendisLogo.url}
        ...
        <div>
          ...
          <ul className="mt-5 space-y-3 text-sm text-ink-foreground/70">
            ...
            <li>
              <a href="tel:+4930692095650" className="hover:text-primary-glow transition-colors">
                030 692095650
              </a>
            </li>
