...
const testimonials = [
  {
    quote: 'Vendis Development Services hat unsere Kommunikationsinfrastruktur grundlegend digitalisiert und die internen Prozesse so optimiert, dass wir deutlich schneller und effizienter agieren können.',
